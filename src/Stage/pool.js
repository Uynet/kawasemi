...
export default class Pool {
  ...
  static Remove(s) {
    ...
    switch (s.name) {
      case "fire":
        this.unused.fires.push(s);
        break;
      case "stone":
        this.unused.stones.push(s);
        break;
      case "smoke":
        this.unused.smokes.push(s);
        break;
      case "sonic":
        this.unused.sonics.push(s);
        break;
      case "flash":
        this.unused.flashes.push(s);
        break;
      default:
        console.warn(s.name);
    }
  ...
  static Get(name, pos, vel, size) {
    switch (name) {
      case "fire":
        return this.GetFire(pos, vel);
        break;
      case "stone":
        return this.GetStone(pos, vel);
        break;
      case "smoke":
        return this.GetSmoke(pos, vel, size);
        break;
      case "sonic":
        return this.GetSonic(pos, vel);
        break;
      case "flash":
        return this.GetFlash(pos, vel);
        break;
      default:
        console.warn(name);
    }
